<div class="animate__animated animate__fadeIn container-fluid mega-menu" id="mega-menu">
  ...
  <script>
    const megamenus = {
      ...
      description: 'Learn about our goals and values.'
        ...
        items: [
      { label: 'Mission, Vision and Values', link: '#', icon: 'mega1.svg' },
      { label: 'Our Leaders', link: '#', icon: 'mega2.svg' },
      { label: 'Ethics & Compliance', link: '#', icon: 'mega3.svg' },
      { label: 'Sustainability', link: '#', icon: 'mega4.svg' }
      ...
      capabilities: {
        title: 'What We Do',
        items: [
          { label: 'Technology', link: '#',  icon: 'mega9.svg' },
          { label: 'Business', link: '#',  icon: 'mega10.svg' },
          { label: 'Engineering', link: '#',  icon: 'mega11.svg' },
          { label: 'Mission', link: '#',  icon: 'mega12.svg' }
      ...
      industries: {
        title: 'Who We Serve',
        items: [
          { label: 'Automotive', link: '#',  icon: 'mega20.svg' },
          { label: 'Banking', link: '#',  icon: 'mega21.svg' },
          { label: 'Defense Intelligence', link: '#',  icon: 'mega22.svg' },
          { label: 'Energy', link: '#',  icon: 'mega23.svg' },
          { label: 'Government', link: '#',  icon: 'mega24.svg' },
          { label: 'Health', link: '#',  icon: 'mega25.svg' }
        ]
      },
      insights: {
        title: 'Preceptive',
        items: [
          { label: 'Articles', link: '#',  icon: 'mega32.svg' },
          { label: 'Blogs', link: '#',  icon: 'mega33.svg' },
          { label: 'Press Release', link: '#',  icon: 'mega34.svg' },
          { label: 'Case Studies', link: '#',  icon: 'mega35.svg' }
      ...
      career: {
        title: 'Search Jobs',
        items: [
          { label: 'Alumni', link: '#',  icon: 'mega39.svg' },
          { label: 'About Life At HPIT', link: '#',  icon: 'mega40.svg' },
          { label: 'Employees Benefits', link: '#',  icon: 'mega41.svg' },
          { label: 'Experienced Professionals', link: '#',  icon: 'mega42.svg' }
    ...
    const megamenus2 = {
      company: {
        title: 'Who ad Are',
        items: [
            { label: 'Diversity, Equity And Inclusion', link: '#', icon: 'mega5.svg' },
            { label: 'Contract Vechicles', link: '#', icon: 'mega6.svg' },
            { label: 'Patnership', link: '#', icon: 'mega7.svg' },
            { label: 'Global', link: '#', icon: 'mega8.svg' }
    ]
      },
      capabilities: {
        title: 'What We Do',
        items: [
            { label: 'Analytics', link: '#',  icon: 'mega13.svg' },
          { label: 'Application', link: '#',  icon: 'mega14.svg' },
          { label: 'Cloud', link: '#',  icon: 'mega15.svg' },
          { label: 'Cyber', link: '#',  icon: 'mega16.svg' },
          { label: 'Digital', link: '#',  icon: 'mega17.svg' },
          { label: 'Enterprice IT', link: '#',  icon: 'mega18.svg' },
          { label: 'WiFi Enterprice', link: '#',  icon: 'mega19.svg' },
      ...
      industries: {
        title: 'Who We Serve',
        items: [
          { label: 'Homeland Security', link: '#',  icon: 'mega26.svg' },
          { label: 'Manufacturing', link: '#',  icon: 'mega27.svg' },
          { label: 'Public', link: '#',  icon: 'mega28.svg' },
          { label: 'Science', link: '#',  icon: 'mega29.svg' },
          { label: 'Space', link: '#',  icon: 'mega30.svg' },
          { label: 'Travel And Transportation', link: '#',  icon: 'mega31.svg' }
        ]
      },
      insights: {
        title: 'Preceptive',
        items: [
          { label: 'In The News', link: '#',  icon: 'mega36.svg' },
          { label: 'Awards & Recognition', link: '#',  icon: 'mega37.svg' },
          { label: 'Events', link: '#',  icon: 'mega38.svg' }
      ...
      career: {
        title: 'Search Jobs',
        items: [
          { label: 'Internship & New Graduates', link: '#',  icon: 'mega43.svg' },
          { label: 'Military Veterans', link: '#',  icon: 'mega44.svg' },
          { label: 'Our Culture', link: '#',  icon: 'mega45.svg' }
 ...
 function populatemegamenu(menuId) {
    ...
    if (megamenus[menuId]) {
        const { title, items, header } = megamenus[menuId];
  ...
  if (megamenus[menuId]) {
    const { title, items } = megamenus[menuId];
    items.forEach(item => {
...
function populatemegamenu2(menuId) {
  ...
  if (megamenus2[menuId]) {
    const { title, items } = megamenus2[menuId];
    items.forEach(item => {
      const li = document.createElement('li');
      const span = document.createElement('span');
      const img = document.createElement('img');
...
document.querySelectorAll('.navbar-nav .nav-item').forEach(menuItem2 => {
  menuItem2.addEventListener('mouseover', (event) => {
    ...
    document.querySelector('div#menuToggler img').setAttribute("src", "assets/img/icons/hamburger-open.svg");
